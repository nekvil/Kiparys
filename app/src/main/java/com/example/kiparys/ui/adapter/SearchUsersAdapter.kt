...
class SearchUsersAdapter(
...
) : ListAdapter<User, SearchUsersAdapter.UserViewHolder>(differCallback) {
    ...
    fun updateSelectedUsers(selectedUsers: List<User>) {
        val oldSelectedUsers = this.selectedUsers
        this.selectedUsers = selectedUsers

        val updatedUsers = (oldSelectedUsers + selectedUsers).distinct()
    ...
    inner class UserViewHolder(private val binding: ItemUserBinding) :
        ...
        fun bind(user: User) {
            ...
            binding.sivCheckMark.visibility =
                if (selectedUsers.contains(user)) View.VISIBLE else View.GONE
